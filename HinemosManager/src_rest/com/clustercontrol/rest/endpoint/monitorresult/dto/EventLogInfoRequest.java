...
public class EventLogInfoRequest implements RequestDto{

	public EventLogInfoRequest(){
	}
	@Override
	...
	private List<EventLogOperationHistoryEntityRequest> eventLogHitory = null;
	...
	public List<EventLogOperationHistoryEntityRequest> getEventLogHitory() {
		return eventLogHitory;
	}
	public void setEventLogHitory(List<EventLogOperationHistoryEntityRequest> eventLogHitory) {
