...
/**
 * カスタムトラップ監視（文字列）情報を削除するクライアント側アクションクラス<br/>
 *
 * @version 6.0.0
 * @since 6.0.0
 */
public class DeleteCustomTrapString implements DeleteInterface {

	/**
	 * カスタムトラップ監視（文字列）情報をマネージャから削除します。<br/>
	 *
	...
	public boolean delete(String managerName, List<String> monitorIdList) throws Exception {
		...
		return wrapper.deleteMonitor(monitorIdList, HinemosModuleConstant.MONITOR_CUSTOMTRAP_S);
	}
}
