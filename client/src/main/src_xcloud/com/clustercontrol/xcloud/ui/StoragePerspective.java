...
import com.clustercontrol.xcloud.ui.views.StorageBackupsView;
import com.clustercontrol.xcloud.ui.views.StoragesView;

public class StoragePerspective extends ClusterControlPerspectiveBase{
	public static final String Id = "com.clustercontrol.xcloud.ui.StoragePerspective";
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		top.addView(StoragesView.Id);
		bottom.addView(StorageBackupsView.Id);
	}
}
