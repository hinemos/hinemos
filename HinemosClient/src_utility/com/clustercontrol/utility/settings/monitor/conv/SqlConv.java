...
public class SqlConv {
	 ...
	 */
	private final static String SCHEMA_TYPE = VersionUtil.getSchemaProperty("MONITOR.SQL.SCHEMATYPE");
	private final static String SCHEMA_VERSION = VersionUtil.getSchemaProperty("MONITOR.SQL.SCHEMAVERSION");
	private final static String SCHEMA_REVISION =VersionUtil.getSchemaProperty("MONITOR.SQL.SCHEMAREVISION");
