...
public class SettingToolsXMLPreferenceInitializer {
	...
	public static void init(IUtilityPreferenceStore store) {
		...
		store.setDefault(XMLConstant.DEFAULT_XML_PLATFORM_REST_ACCESS,
		...
		store.setDefault(XMLConstant.DEFAULT_XML_JOB_JOBLINKRCV,
				XMLConstant.DEFAULT_XML_JOB_JOBLINKRCV);
		store.setDefault(XMLConstant.DEFAULT_XML_JOB_QUEUE,
				XMLConstant.DEFAULT_XML_JOB_QUEUE);
		store.setDefault(XMLConstant.DEFAULT_XML_JOB_JOBLINKSEND,
		...
		store.setDefault(XMLConstant.DEFAULT_XML_RPA_SCENARIO_TAG,
				XMLConstant.DEFAULT_XML_RPA_SCENARIO_TAG);
		store.setDefault(XMLConstant.DEFAULT_XML_RPA_SCENARIO_OPERATION_RESULT_CREATE_SETTING,
				XMLConstant.DEFAULT_XML_RPA_SCENARIO_OPERATION_RESULT_CREATE_SETTING);
		store.setDefault(XMLConstant.DEFAULT_XML_RPA_MANAGEMENT_TOOL_ACCOUNT,
				XMLConstant.DEFAULT_XML_RPA_MANAGEMENT_TOOL_ACCOUNT);
		store.setDefault(XMLConstant.DEFAULT_XML_RPA_SCENARIO_COEFFICIENT_PATTERN,
				XMLConstant.DEFAULT_XML_RPA_SCENARIO_COEFFICIENT_PATTERN);
		store.setDefault(XMLConstant.DEFAULT_XML_MONITOR_RPA_LOGFILE,
				XMLConstant.DEFAULT_XML_MONITOR_RPA_LOGFILE);
		store.setDefault(XMLConstant.DEFAULT_XML_MONITOR_RPA_MANAGEMENT_TOOL_SERVICE,
		...
		store.setDefault(XMLConstant.DEFAULT_XML_CLOUD_MON_LOG,
				XMLConstant.DEFAULT_XML_CLOUD_MON_LOG);

		store.setDefault(XMLConstant.DEFAULT_XML_MSGFILTER_MFPROPERTY,
				XMLConstant.DEFAULT_XML_MSGFILTER_MFPROPERTY);
