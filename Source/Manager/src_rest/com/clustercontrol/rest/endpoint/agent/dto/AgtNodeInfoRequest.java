...
@RestBeanConvertAssertion(to = NodeInfo.class)
public class AgtNodeInfoRequest extends AgentRequestDto {
	...
	private AgtNodeOsInfoRequest nodeOsInfo;
	private List<AgtNodeCpuInfoRequest> nodeCpuInfo;
	private List<AgtNodeGeneralDeviceInfoRequest> nodeDeviceInfo;
	private List<AgtNodeDiskInfoRequest> nodeDiskInfo;
	private List<AgtNodeFilesystemInfoRequest> nodeFilesystemInfo;
	private List<AgtNodeHostnameInfoRequest> nodeHostnameInfo;
	private List<AgtNodeMemoryInfoRequest> nodeMemoryInfo;
	private List<AgtNodeNetworkInterfaceInfoRequest> nodeNetworkInterfaceInfo;
	private List<AgtNodeNoteInfoRequest> nodeNoteInfo;
	private List<AgtNodeVariableInfoRequest> nodeVariableInfo;
	private List<AgtNodeNetstatInfoRequest> nodeNetstatInfo;
	private List<AgtNodeProcessInfoRequest> nodeProcessInfo;
	private List<AgtNodePackageInfoRequest> nodePackageInfo;
	private List<AgtNodeProductInfoRequest> nodeProductInfo;
	private List<AgtNodeLicenseInfoRequest> nodeLicenseInfo;
	private List<AgtNodeCustomInfoRequest> nodeCustomInfo;
	...
	private List<AgtNodeConfigFilterInfoRequest> nodeConfigFilterList;
	private Long nodeConfigTargetDatetime;

	public AgtNodeInfoRequest() {
	}
	...
	public AgtNodeOsInfoRequest getNodeOsInfo() {
		return nodeOsInfo;
	}

	public void setNodeOsInfo(AgtNodeOsInfoRequest nodeOsInfo) {
		this.nodeOsInfo = nodeOsInfo;
	}

	public List<AgtNodeCpuInfoRequest> getNodeCpuInfo() {
		return nodeCpuInfo;
	}

	public void setNodeCpuInfo(List<AgtNodeCpuInfoRequest> nodeCpuInfo) {
		this.nodeCpuInfo = nodeCpuInfo;
	}

	public List<AgtNodeGeneralDeviceInfoRequest> getNodeDeviceInfo() {
		return nodeDeviceInfo;
	}

	public void setNodeDeviceInfo(List<AgtNodeGeneralDeviceInfoRequest> nodeDeviceInfo) {
		this.nodeDeviceInfo = nodeDeviceInfo;
	}

	public List<AgtNodeDiskInfoRequest> getNodeDiskInfo() {
		return nodeDiskInfo;
	}

	public void setNodeDiskInfo(List<AgtNodeDiskInfoRequest> nodeDiskInfo) {
		this.nodeDiskInfo = nodeDiskInfo;
	}

	public List<AgtNodeFilesystemInfoRequest> getNodeFilesystemInfo() {
		return nodeFilesystemInfo;
	}

	public void setNodeFilesystemInfo(List<AgtNodeFilesystemInfoRequest> nodeFilesystemInfo) {
		this.nodeFilesystemInfo = nodeFilesystemInfo;
	}

	public List<AgtNodeHostnameInfoRequest> getNodeHostnameInfo() {
		return nodeHostnameInfo;
	}

	public void setNodeHostnameInfo(List<AgtNodeHostnameInfoRequest> nodeHostnameInfo) {
		this.nodeHostnameInfo = nodeHostnameInfo;
	}

	public List<AgtNodeMemoryInfoRequest> getNodeMemoryInfo() {
		return nodeMemoryInfo;
	}

	public void setNodeMemoryInfo(List<AgtNodeMemoryInfoRequest> nodeMemoryInfo) {
		this.nodeMemoryInfo = nodeMemoryInfo;
	}

	public List<AgtNodeNetworkInterfaceInfoRequest> getNodeNetworkInterfaceInfo() {
		return nodeNetworkInterfaceInfo;
	}

	public void setNodeNetworkInterfaceInfo(List<AgtNodeNetworkInterfaceInfoRequest> nodeNetworkInterfaceInfo) {
		this.nodeNetworkInterfaceInfo = nodeNetworkInterfaceInfo;
	}

	public List<AgtNodeNoteInfoRequest> getNodeNoteInfo() {
		return nodeNoteInfo;
	}

	public void setNodeNoteInfo(List<AgtNodeNoteInfoRequest> nodeNoteInfo) {
		this.nodeNoteInfo = nodeNoteInfo;
	}

	public List<AgtNodeVariableInfoRequest> getNodeVariableInfo() {
		return nodeVariableInfo;
	}

	public void setNodeVariableInfo(List<AgtNodeVariableInfoRequest> nodeVariableInfo) {
		this.nodeVariableInfo = nodeVariableInfo;
	}

	public List<AgtNodeNetstatInfoRequest> getNodeNetstatInfo() {
		return nodeNetstatInfo;
	}

	public void setNodeNetstatInfo(List<AgtNodeNetstatInfoRequest> nodeNetstatInfo) {
		this.nodeNetstatInfo = nodeNetstatInfo;
	}

	public List<AgtNodeProcessInfoRequest> getNodeProcessInfo() {
		return nodeProcessInfo;
	}

	public void setNodeProcessInfo(List<AgtNodeProcessInfoRequest> nodeProcessInfo) {
		this.nodeProcessInfo = nodeProcessInfo;
	}

	public List<AgtNodePackageInfoRequest> getNodePackageInfo() {
		return nodePackageInfo;
	}

	public void setNodePackageInfo(List<AgtNodePackageInfoRequest> nodePackageInfo) {
		this.nodePackageInfo = nodePackageInfo;
	}

	public List<AgtNodeProductInfoRequest> getNodeProductInfo() {
		return nodeProductInfo;
	}

	public void setNodeProductInfo(List<AgtNodeProductInfoRequest> nodeProductInfo) {
		this.nodeProductInfo = nodeProductInfo;
	}

	public List<AgtNodeLicenseInfoRequest> getNodeLicenseInfo() {
		return nodeLicenseInfo;
	}

	public void setNodeLicenseInfo(List<AgtNodeLicenseInfoRequest> nodeLicenseInfo) {
		this.nodeLicenseInfo = nodeLicenseInfo;
	}

	public List<AgtNodeCustomInfoRequest> getNodeCustomInfo() {
		return nodeCustomInfo;
	}

	public void setNodeCustomInfo(List<AgtNodeCustomInfoRequest> nodeCustomInfo) {
	...
	public List<AgtNodeConfigFilterInfoRequest> getNodeConfigFilterList() {
		return nodeConfigFilterList;
	}

	public void setNodeConfigFilterList(List<AgtNodeConfigFilterInfoRequest> nodeConfigFilterList) {
