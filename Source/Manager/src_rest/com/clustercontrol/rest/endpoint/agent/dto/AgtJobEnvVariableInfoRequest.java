...
@RestBeanConvertAssertion(to = JobEnvVariableInfo.class)
public class AgtJobEnvVariableInfoRequest extends AgentRequestDto {
	...
	public AgtJobEnvVariableInfoRequest() {
	}
