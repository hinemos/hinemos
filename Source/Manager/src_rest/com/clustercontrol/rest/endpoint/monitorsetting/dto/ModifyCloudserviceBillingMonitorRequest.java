...
public class ModifyCloudserviceBillingMonitorRequest extends AbstractModifyNumericMonitorRequest {

	public ModifyCloudserviceBillingMonitorRequest() {
	...
	public String toString() {
		return "ModifyCloudserviceBillingMonitorRequest [pluginCheckInfo=" + pluginCheckInfo + ", collectorFlg="
