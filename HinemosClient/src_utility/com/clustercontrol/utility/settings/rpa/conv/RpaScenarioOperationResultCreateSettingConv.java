...
public class RpaScenarioOperationResultCreateSettingConv {
	 ...
	 */
	static private final String schemaType=VersionUtil.getSchemaProperty("RPA.RPASCENARIOOPERATIONRESULTCREATESETTING.SCHEMATYPE");
	static private final String schemaVersion=VersionUtil.getSchemaProperty("RPA.RPASCENARIOOPERATIONRESULTCREATESETTING.SCHEMAVERSION");
	static private final String schemaRevision=VersionUtil.getSchemaProperty("RPA.RPASCENARIOOPERATIONRESULTCREATESETTING.SCHEMAREVISION");
