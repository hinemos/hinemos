...
@RestBeanConvertAssertion(to = RunInstructionFileCheckInfo.class)
public class AgtRunInstructionFileCheckInfoRequest extends AgentRequestDto {
	...
	public AgtRunInstructionFileCheckInfoRequest() {
	}
