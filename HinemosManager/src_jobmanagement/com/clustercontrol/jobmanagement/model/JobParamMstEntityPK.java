 ...
 */
@Embeddable
public class JobParamMstEntityPK implements Serializable {
	...
	public JobParamMstEntityPK() {
	}

	public JobParamMstEntityPK(String jobunitId, String jobId, String paramId) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof JobParamMstEntityPK)) {
			return false;
		}
		JobParamMstEntityPK castOther = (JobParamMstEntityPK)other;
		return
