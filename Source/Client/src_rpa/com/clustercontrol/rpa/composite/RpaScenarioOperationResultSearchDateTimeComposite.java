 ...
 * 検索画面の時刻表示用コンポジット
 */
public class RpaScenarioOperationResultSearchDateTimeComposite extends Composite{
	//ログ
	private static Logger logger  = Logger.getLogger(RpaScenarioOperationResultSearchDateTimeComposite.class);
	...
	public RpaScenarioOperationResultSearchDateTimeComposite(Composite parent, int style) {
		super(parent, style);
		initizlize();
	}
