...
@RestBeanConvertAssertion(from = BinaryPatternInfo.class)
@RestBeanConvertIdClassSet(infoClass = BinaryPatternInfo.class, idName = "id")
public class AgtBinaryPatternInfoResponse {

	// ---- from MonitorStringValueInfoPK
	private String monitorId;
	// private Integer orderNo; // XmlTransient指定されていたので除外
	...
	public AgtBinaryPatternInfoResponse() {
	}
