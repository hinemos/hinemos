...
@RestBeanConvertAssertion(from = NodeConfigCustomInfo.class)
@RestBeanConvertIdClassSet(infoClass = NodeConfigCustomInfo.class, idName = "id")
public class AgtNodeConfigCustomInfoResponse {

	// ---- from NodeConfigCustomInfoPK
	// private String settingId;
	private String settingCustomId;

	// ---- from NodeConfigCustomInfo
	...
	// private NodeConfigSettingInfo nodeConfigSettingInfo; // 循環参照させない

	public AgtNodeConfigCustomInfoResponse() {
	}
