...
public class JobRpaInfoResponse {
	...
	/** 実行オプション */
	private List<JobRpaOptionInfoResponse> rpaJobOptionInfos;

	/** 終了値判定条件 */
	private List<JobRpaEndValueConditionInfoResponse> rpaJobEndValueConditionInfos;
	...
	/** 起動パラメータ */
	private List<JobRpaRunParamInfoResponse> rpaJobRunParamInfos;
	...
	/** 終了値判定条件 */
	private List<JobRpaCheckEndValueInfoResponse> rpaJobCheckEndValueInfos;

	public JobRpaInfoResponse() {
	}
	 ...
	 */
	public List<JobRpaOptionInfoResponse> getRpaJobOptionInfos() {
	 ...
	 */
	public void setRpaJobOptionInfos(List<JobRpaOptionInfoResponse> rpaJobOptionInfos) {
	 ...
	 */
	public List<JobRpaEndValueConditionInfoResponse> getRpaJobEndValueConditionInfos() {
	 ...
	 */
	public void setRpaJobEndValueConditionInfos(
			List<JobRpaEndValueConditionInfoResponse> rpaJobEndValueConditionInfos) {
	 ...
	 */
	public List<JobRpaRunParamInfoResponse> getRpaJobRunParamInfos() {
	 ...
	 */
	public void setRpaJobRunParamInfos(List<JobRpaRunParamInfoResponse> rpaJobRunParamInfos) {
	 ...
	 */
	public List<JobRpaCheckEndValueInfoResponse> getRpaJobCheckEndValueInfos() {
	 ...
	 */
	public void setRpaJobCheckEndValueInfos(List<JobRpaCheckEndValueInfoResponse> rpaJobCheckEndValueInfos) {
