...
public class TrapValueInfoRequest implements RequestDto {
	private String mib;
	...
	private List<VarBindPatternRequest> varBindPatterns = new ArrayList<>();
	public TrapValueInfoRequest() {
	}
	...
	public List<VarBindPatternRequest> getVarBindPatterns() {
		return varBindPatterns;
	}
	public void setVarBindPatterns(List<VarBindPatternRequest> varBindPatterns) {
