...
public class ProcessConv {
	 ...
	 */
	private final static String SCHEMA_TYPE = VersionUtil.getSchemaProperty("MONITOR.PROCESS.SCHEMATYPE");
	private final static String SCHEMA_VERSION = VersionUtil.getSchemaProperty("MONITOR.PROCESS.SCHEMAVERSION");
	private final static String SCHEMA_REVISION =VersionUtil.getSchemaProperty("MONITOR.PROCESS.SCHEMAREVISION");
