...
public class UpOrderInfraModuleAction extends AbstractHandler implements IElementUpdater {
	/** ログ */
	private static Log m_log = LogFactory.getLog(UpOrderInfraModuleAction.class);
			...
			if( null != page ){
				...
				if(part instanceof InfraModuleView){
					...
					if(selection != null && selection.size() == 1
							...
							&& (Integer)((ArrayList<?>)selection.getFirstElement()).get(GetInfraModuleTableDefine.ORDER_NO) > 1){
						enable = true;
					}
				}
