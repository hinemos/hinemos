...
/**
 * SDML制御設定を有効化するビューアクション
 *
 */
public class SdmlControlSettingEnableAction extends SdmlSettingEnableBaseAction {
	private static Log logger = LogFactory.getLog(SdmlControlSettingEnableAction.class);

	/** アクションID */
	public static final String ID = SdmlControlSettingEnableAction.class.getName();
