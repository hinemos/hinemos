 ...
 * @version 5.1.0
 */
public class CreateMonitorJobAction extends AbstractHandler implements IElementUpdater {
	/** ログ */
	private static Log m_log = LogFactory.getLog(CreateMonitorJobAction.class);
	/** アクションID */
	public static final String ID = CreateMonitorJobAction.class.getName();
	...
	/**
	 * ジョブ[一覧]ビューの「監視ジョブの作成」が押された場合に、監視ジョブを作成します。
	 * <p>
	 * <ol>
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (parent != null) {
			JobInfoWrapper jobInfo = JobTreeItemUtil.getNewJobInfo(parent.getData().getJobunitId(),
					JobInfoWrapper.TypeEnum.MONITORJOB);
