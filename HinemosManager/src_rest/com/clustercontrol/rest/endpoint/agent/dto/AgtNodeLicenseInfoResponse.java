...
@RestBeanConvertAssertion(from = NodeLicenseInfo.class)
@RestBeanConvertIdClassSet(infoClass = NodeLicenseInfo.class, idName = "id")
public class AgtNodeLicenseInfoResponse {

	// ---- from NodeLicenseInfoPK
	// private String facilityId;
	private String productName;

	// ---- from NodeLicenseInfo
	...
	public AgtNodeLicenseInfoResponse() {
	}
