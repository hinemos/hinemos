...
@RestBeanConvertAssertion(to = OutputBasicInfo.class)
public class AgtOutputBasicInfoRequest extends AgentRequestDto {
	...
	private List<String> jobFacilityId;
	...
	public AgtOutputBasicInfoRequest() {
	}
	...
	public void setJobApprovalMail(String jobApprovalMail) {
		this.jobApprovalMail = jobApprovalMail;
	}
	...
	public void setJobApprovalText(String jobApprovalText) {
		this.jobApprovalText = jobApprovalText;
	}
	...
	public void setJobFacilityId(List<String> jobFacilityId) {
