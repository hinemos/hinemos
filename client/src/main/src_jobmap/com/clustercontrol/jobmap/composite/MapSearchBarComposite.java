 ...
 * @since 6.1.0
 */
public class MapSearchBarComposite extends Composite{
	...
	private JobMapComposite m_compose;
	public MapSearchBarComposite( Composite parent, int style, boolean enableKeyPress ){
		super( parent, style );
	...
	public void setJobMapComposite(JobMapComposite target){
		m_compose = target;
	}
}
