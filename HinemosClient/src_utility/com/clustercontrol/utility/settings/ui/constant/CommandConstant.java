...
public class CommandConstant {
	...
	public static final String ACTION_PLATFORM_REST_ACCESS = "com.clustercontrol.utility.settings.platform.action.RestAccessAction";
	...
	public static final String ACTION_MONITOR_RPA_LOGFILE = "com.clustercontrol.utility.settings.monitor.action.RpaLogfileAction";
	public static final String ACTION_MONITOR_RPA_MANAGEMENT_TOOL_SERVICE = "com.clustercontrol.utility.settings.monitor.action.RpaManagementToolServiceAction";
	...
	public static final String ACTION_JOB_JOBLINKSEND = "com.clustercontrol.utility.settings.job.action.JobLinkSendAction";
	...
	public static final String ACTION_CLOUD_MON_LOG = "com.clustercontrol.utility.settings.monitor.action.CloudLogAction";
	public static final String ACTION_RPA_SCENARIO_TAG = "com.clustercontrol.utility.settings.rpa.action.RpaScenarioTagAction";
	public static final String ACTION_RPA_SCENARIO_OPE_RESULT_CREATE_SETTING = "com.clustercontrol.utility.settings.rpa.action.RpaScenarioOperationResultCreateSettingAction";
	public static final String ACTION_RPA_MANAGEMENT_TOOL_ACCOUNT = "com.clustercontrol.utility.settings.rpa.action.RpaManagementToolAccountAction";
	public static final String ACTION_RPA_SCENARIO_COEFFICIENT_PATTERN = "com.clustercontrol.utility.settings.rpa.action.RpaScenarioCoefficientPatternAction";
	
	public static final String ACTION_FILTER_SETTING_MONITOR_HISTORY_EVENT = "com.clustercontrol.utility.settings.filtersetting.action.MonitorHistoryEventAction";
	public static final String ACTION_FILTER_SETTING_MONITOR_HISTORY_STATUS = "com.clustercontrol.utility.settings.filtersetting.action.MonitorHistoryStatusAction";
	public static final String ACTION_FILTER_SETTING_JOB_HISTORY = "com.clustercontrol.utility.settings.filtersetting.action.JobHistoryAction";

	public static final String ACTION_MSGFILTER_MFPROPERTY = "com.clustercontrol.msgfilter.utility.settings.action.MFPropertyAction";
	...
	public static final int WEIGHT_CLOUD_MON_LOG = 1203;
	public static final int WEIGHT_RPA_SCENARIO_TAG = 1300;
	public static final int WEIGHT_RPA_SCENARIO_OPE_RESULT_CREATE_SETTING = 1301;
	public static final int WEIGHT_RPA_MANAGEMENT_TOOL_ACCOUNT = 1302;
	public static final int WEIGHT_RPA_SCENARIO_COEFFICIENT_PATTERN = 1303;
	public static final int WEIGHT_SDML_BASE = 1400; // ※SDMLはこの数値を基準にClientOption側で調整するため重複に注意

	public static final int WEIGHT_FILTER_SETTING_MONITOR_HISTORY_EVENT = 1500;
	public static final int WEIGHT_FILTER_SETTING_MONITOR_HISTORY_STATUS = 1501;
	public static final int WEIGHT_FILTER_SETTING_JOB_HISTORY = 1502;

	public static final int WEIGHT_MSGFILTER_MFPROPERTY = 1600;
