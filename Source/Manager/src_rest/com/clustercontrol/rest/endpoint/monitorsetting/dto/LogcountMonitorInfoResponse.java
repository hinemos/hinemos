...
public class LogcountMonitorInfoResponse extends AbstractNumericMonitorResponse {

	private LogcountCheckInfoResponse logcountCheckInfo;

	public LogcountMonitorInfoResponse() {
	}
	...
	public String toString() {
		return "LogcountMonitorInfoResponse [logcountCheckInfo=" + logcountCheckInfo + ", collectorFlg=" + collectorFlg
