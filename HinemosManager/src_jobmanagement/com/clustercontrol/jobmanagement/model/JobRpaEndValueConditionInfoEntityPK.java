...
@Embeddable
public class JobRpaEndValueConditionInfoEntityPK implements Serializable {
	...
	public JobRpaEndValueConditionInfoEntityPK() {
	}

	public JobRpaEndValueConditionInfoEntityPK(String sessionId, String jobunitId, String jobId, Integer orderNo) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof JobRpaEndValueConditionInfoEntityPK)) {
			return false;
		}
		JobRpaEndValueConditionInfoEntityPK castOther = (JobRpaEndValueConditionInfoEntityPK)other;
		return
