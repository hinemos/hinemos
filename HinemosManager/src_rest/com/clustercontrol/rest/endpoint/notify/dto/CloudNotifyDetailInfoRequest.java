...
public class CloudNotifyDetailInfoRequest implements RequestDto {
	...
	@RestPartiallyTransrateTarget
	private List<CloudNotifyLinkInfoKeyValueObjectRequest> infoKeyValueDataList;
	...
	// jsonデータでディテールおよびデータを保存
	@RestPartiallyTransrateTarget
	private List<CloudNotifyLinkInfoKeyValueObjectRequest> warnKeyValueDataList;
	...
	// jsonデータでディテールおよびデータを保存
	@RestPartiallyTransrateTarget
	private List<CloudNotifyLinkInfoKeyValueObjectRequest> critKeyValueDataList;
	...
	// jsonデータでディテールおよびデータを保存
	@RestPartiallyTransrateTarget
	private List<CloudNotifyLinkInfoKeyValueObjectRequest> unkKeyValueDataList;
	...
	public List<CloudNotifyLinkInfoKeyValueObjectRequest> getInfoKeyValueDataList() {
		return infoKeyValueDataList;
	}
	public void setInfoKeyValueDataList(List<CloudNotifyLinkInfoKeyValueObjectRequest> infoKeyValueDataList) {
	...
	public List<CloudNotifyLinkInfoKeyValueObjectRequest> getWarnKeyValueDataList() {
		return warnKeyValueDataList;
	}
	public void setWarnKeyValueDataList(List<CloudNotifyLinkInfoKeyValueObjectRequest> warnKeyValueDataList) {
	...
	public List<CloudNotifyLinkInfoKeyValueObjectRequest> getCritKeyValueDataList() {
		return critKeyValueDataList;
	}
	public void setCritKeyValueDataList(List<CloudNotifyLinkInfoKeyValueObjectRequest> critKeyValueDataList) {
	...
	public List<CloudNotifyLinkInfoKeyValueObjectRequest> getUnkKeyValueDataList() {
		return unkKeyValueDataList;
	}
	public void setUnkKeyValueDataList(List<CloudNotifyLinkInfoKeyValueObjectRequest> unkKeyValueDataList) {
