...
@RestBeanConvertAssertion(from = NodeProductInfo.class)
@RestBeanConvertIdClassSet(infoClass = NodeProductInfo.class, idName = "id")
public class AgtNodeProductInfoResponse {

	// --- from NodeProductInfoPK
	// private String facilityId;
	private String productName;

	// --- from NodeProductInfo
	...
	public AgtNodeProductInfoResponse() {
	}
