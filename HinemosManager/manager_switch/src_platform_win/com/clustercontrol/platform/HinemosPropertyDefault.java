...
public class HinemosPropertyDefault {
	...
	static {
		...
		DATA_DIR = System.getProperty("hinemos.manager.data.dir");
		USER_HOME_DIR = System.getProperty("user.home");
	}
	
	/** infra.export.dir */
	private static final String INFRA_EXPORT_DIR = DATA_DIR + "/export/";
	
	/** infra.transfer.dir */
	private static final String INFRA_TRANSFER_DIR = DATA_DIR + "/infra/";
	
	/** internal.command.commandline */
	private static final String INTERNAL_COMMAND_COMMANDLINE = "cmd /c echo #[GENERATION_DATE] #[MESSAGE] >> %TEMP%\test.txt";
	
	/** internal.command.user */
	private static final String INTERNAL_COMMAND_USER = "Administrator";
	
	/** monitor.ping.fping.path */
	private static final String MONITOR_PING_FPING_PATH = HOME_DIR + "/sbin/fping.ps1";
	
	/** monitor.ping.fping6.path */
	private static final String MONITOR_PING_FPING6_PATH = MONITOR_PING_FPING_PATH;
	
	/** performance.export.dir */
	private static final String PERFORMANCE_EXPORT_DIR = DATA_DIR + "/export/";
	
	/** selfcheck.monitoring.db.validationquery */
	private static final String SELFCHECK_MONITORING_DB_VALIDATIONQUERY = "SELECT 1";
	
	/** windows.eventlog (Windows only.) */
	private static final boolean WINDOWS_EVENTLOG = true;
	
	/** ws.https.keystore.path */
	private static final String WS_HTTPS_KEYSTORE_PATH = USER_HOME_DIR + "/keystore";
