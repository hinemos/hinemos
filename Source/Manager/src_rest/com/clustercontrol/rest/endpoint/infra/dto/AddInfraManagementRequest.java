...
public class AddInfraManagementRequest implements RequestDto {
	...
	@RestValidateString(maxLen = 512, minLen = 0)
	...
	public String toString() {
		return "AddInfraManagementRequest [ownerRoleId=" + ownerRoleId + ", managementId=" + managementId + ", name="
				+ name + ", description=" + description + ", facilityId=" + facilityId + ", validFlg=" + validFlg
				+ ", startPriority=" + startPriority + ", normalPriorityRun=" + normalPriorityRun
