...
/**
 * The primary key class for the cc_job_wait_mst database table.
 * 
 */
@Embeddable
public class JobWaitMstEntityPK implements Serializable {
	...
	public JobWaitMstEntityPK() {
	}

	public JobWaitMstEntityPK(String jobunitId,
			String jobId,
			Integer orderNo,
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof JobWaitMstEntityPK)) {
			return false;
		}
		JobWaitMstEntityPK castOther = (JobWaitMstEntityPK)other;
		return this.jobunitId.equals(castOther.jobunitId)
