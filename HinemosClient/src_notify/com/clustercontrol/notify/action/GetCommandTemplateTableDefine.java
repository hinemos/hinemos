...
/**
 * コマンド通知テンプレート情報一覧のテーブル定義情報を取得するクライアント側アクションクラス<BR>
 */
public class GetCommandTemplateTableDefine {

	/** Manager Name */
	public static final int MANAGER_NAME = 0;

	/** コマンド通知テンプレートID */
	public static final int COMMAND_TEMPLATE_ID = 1;
	...
	public static final int SORT_COLUMN_INDEX2 = COMMAND_TEMPLATE_ID;

	/** 初期表示時ソートオーダー */
	public static final int SORT_ORDER = 1;

	/**
	 * コマンド通知テンプレート情報一覧のテーブル定義情報を返します。<BR>
	...
	public static ArrayList<TableColumnInfo> get() {
		...
		tableDefine.add(MANAGER_NAME,
				new TableColumnInfo(Messages.getString("word.manager", "Manager", locale), TableColumnInfo.MANAGER_NAME, 100, SWT.LEFT));
		tableDefine.add(COMMAND_TEMPLATE_ID,
				new TableColumnInfo(Messages.getString("command.template.id", locale), TableColumnInfo.NONE, 170, SWT.LEFT));
