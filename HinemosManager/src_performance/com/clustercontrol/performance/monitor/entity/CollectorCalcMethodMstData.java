 ...
 * @version 4.0.1
 */
public class CollectorCalcMethodMstData
...
implements java.io.Serializable
{
	...
	public CollectorCalcMethodMstData( java.lang.String calcMethod,java.lang.String className,java.lang.String expression )
	{
	...
	public String toString()
	{
		...
		str.append("calcMethod=" + getCalcMethod() + " " + "className=" + getClassName() + " " + "expression=" + getExpression());
		str.append('}');
