...
public class SettingConstants {
	...
	public static final int SUCCESS_DIFF_3 = (int)Math.pow(2,2);
	public static final int SUCCESS_DIFF_4 = (int)Math.pow(2,3);
	public static final int SUCCESS_DIFF_5 = (int)Math.pow(2,4);
	public static final int SUCCESS_DIFF_6 = (int)Math.pow(2,5);
	public static final int SUCCESS_DIFF_7 = (int)Math.pow(2,6);
