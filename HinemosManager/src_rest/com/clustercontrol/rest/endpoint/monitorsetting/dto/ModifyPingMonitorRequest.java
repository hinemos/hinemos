...
public class ModifyPingMonitorRequest extends AbstractModifyNumericMonitorRequest {

	public ModifyPingMonitorRequest() {
	...
	public String toString() {
		return "ModifyPingMonitorRequest [pingCheckInfo=" + pingCheckInfo + ", collectorFlg=" + collectorFlg
