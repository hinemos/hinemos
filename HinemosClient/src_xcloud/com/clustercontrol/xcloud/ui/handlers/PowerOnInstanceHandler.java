...
public class PowerOnInstanceHandler extends AbstractCloudOptionHandler implements CloudStringConstants {
	@Override
	public Object internalExecute(ExecutionEvent event) throws CloudManagerException, InvalidUserPass, InvalidRole, RestConnectFailed, HinemosUnknown {
		...
		if (MessageDialog.openConfirm(
			...
			endpoint.powerOnInstances(instance.getCloudScope().getId(), instance.getLocation().getId(), String.join(",", instanceIds));
	...
	protected String getErrorMessage() {
		return msgErrorFinishPowerOnComputeNode;
	}
}
