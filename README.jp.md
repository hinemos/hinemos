...
[README(English)](README.md) | [Hinemosポータル](http://www.hinemos.info/) | [パッケージダウンロード](https://github.com/hinemos/hinemos/releases/tag/v7.1.2#packages_712)
...
詳細は[Hinemos ver.7.1 基本機能マニュアル](https://github.com/hinemos/hinemos/releases/download/v7.1.2/ja_Base_Linux_7.1_rev17.pdf)をご覧下さい。
...
- Hinemos ver.7.1 基本機能マニュアル ([ja_Base_Linux_7.1_rev17.pdf](https://github.com/hinemos/hinemos/releases/download/v7.1.2/ja_Base_Linux_7.1_rev17.pdf) )
