...
implements IWorkbenchPreferencePage {
	...
	private static final String VALUE_DIFF_MODE = "false";
	...
	public static class Initializer extends AbstractPreferenceInitializer {
		...
		public void initializeDefaultPreferences() {
			...
			store.setDefault(KEY_XML, VALUE_XML);
			store.setDefault(KEY_DIFF_XML, VALUE_DIFF_XML);
			store.setDefault(KEY_DIFF_MODE, VALUE_DIFF_MODE);
			store.setDefault(VALUE_INFRA, VALUE_INFRA);
			store.setDefault(VALUE_NODEMAP_BG_FOLDER, VALUE_NODEMAP_BG_FOLDER);
			store.setDefault(VALUE_NODEMAP_ICON_FOLDER, VALUE_NODEMAP_ICON_FOLDER);
			
			store.setDefault(VALUE_JOBMAP_IMAGE_FOLDER, VALUE_JOBMAP_IMAGE_FOLDER);
			
			store.setDefault(KEY_BACKUP_IMPORT, DEFAULT_VALUE_BACKUP_IMPORT);
			store.setDefault(KEY_BACKUP_EXPORT, DEFAULT_VALUE_BACKUP_EXPORT);
			store.setDefault(KEY_BACKUP_CLEAR, DEFAULT_VALUE_BACKUP_CLEAR);
			store.setDefault(VALUE_BACKUP_FOLDER, VALUE_BACKUP_FOLDER);
