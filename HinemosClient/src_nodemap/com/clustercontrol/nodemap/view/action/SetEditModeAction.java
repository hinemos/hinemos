 ...
 * @since 1.0.0
 */
public class SetEditModeAction extends AbstractHandler implements IElementUpdater {
	/** アクションID */
	public static final String ID = OpenNodeMapAction.ActionIDBase + SetEditModeAction.class.getSimpleName();
	...
	public void updateElement(UIElement element, @SuppressWarnings("rawtypes") Map parameters) {
		...
		if (viewPart instanceof NodeMapView) {
			...
			if (view.getMode() == NodeMapView.Mode.EDIT_CONNECTION_MODE) {
