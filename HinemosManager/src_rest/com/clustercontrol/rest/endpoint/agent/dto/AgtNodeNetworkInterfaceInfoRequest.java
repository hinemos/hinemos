...
@RestBeanConvertAssertion(to = NodeNetworkInterfaceInfo.class)
@RestBeanConvertIdClassSet(infoClass = NodeDeviceInfo.class, idName = "id")
public class AgtNodeNetworkInterfaceInfoRequest extends AgentRequestDto {
	...
	// ---- from NodeDeviceInfo
	//private NodeDeviceInfoPK id; // 上記展開済み
	...
	public AgtNodeNetworkInterfaceInfoRequest() {
	}
