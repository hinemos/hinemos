...
public class LogEscalateNotifyDetailInfoRequest implements RequestDto {
	...
	@RestItemName(value = MessageConstant.PORT_NUMBER)
	...
	public LogEscalateNotifyDetailInfoRequest() {
	}
