 ...
 *
 */
public class CreateJobLinkRcvJobAction extends AbstractHandler implements IElementUpdater {
	/** ログ */
	private static Log m_log = LogFactory.getLog(CreateJobLinkRcvJobAction.class);
	/** アクションID */
	public static final String ID = CreateJobLinkRcvJobAction.class.getName();
	...
	/**
	 * ジョブ[一覧]ビューの「ジョブ連携待機ジョブの作成」が押された場合に、ジョブ連携待機ジョブを作成します。
	 * <p>
	 * <ol>
	 * <li>ジョブ[一覧]ビューから親となるジョブツリーアイテムを取得します。</li>
	 * <li>ジョブ連携待機ジョブ用のジョブ情報を作成し、親のジョブツリーアイテムの子として追加します。</li>
	 * <li>ジョブ[ジョブ連携待機ジョブの作成・変更]ダイアログを表示します。</li>
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (parent != null) {
			JobInfoWrapper jobInfo = JobTreeItemUtil.getNewJobInfo(parent.getData().getJobunitId(),
					JobInfoWrapper.TypeEnum.JOBLINKRCVJOB);
