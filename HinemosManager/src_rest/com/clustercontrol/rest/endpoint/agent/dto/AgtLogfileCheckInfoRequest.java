...
@RestBeanConvertAssertion(to = LogfileCheckInfo.class)
public class AgtLogfileCheckInfoRequest extends AgentRequestDto {

	// ---- from LogfileCheckInfo
	...
	public AgtLogfileCheckInfoRequest() {
	}
