 ...
 */
@Embeddable
public class RestAccessSendHttpHeaderPK implements Serializable {
	private static final long serialVersionUID = 1L;

	private String restAccessId ;
	private Long headerOrderNo;

	public RestAccessSendHttpHeaderPK() {
		super();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RestAccessSendHttpHeaderPK other = (RestAccessSendHttpHeaderPK) obj;
