...
/**
 * 収集蓄積[エクスポート]の作成・変更ダイアログによる、収集蓄積[エクスポート]の設定変更を行うクライアント側アクションクラス<BR>
 *
 */
public class LogTransferModifyAction extends AbstractHandler implements IElementUpdater{

	/** CommandId */
	public static final String ID = LogTransferModifyAction.class.getName();
	...
	public Object execute(final ExecutionEvent event) throws ExecutionException {
		...
		// 収集蓄積[エクスポート]の一覧より、選択されているフォーマットIDを取得
