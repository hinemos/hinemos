...
package com.clustercontrol.rpa.commons;
 ...
 */
public class RpaScenarioOperationResultSearchPeriodConstants {
	public static final String ALL = Messages.getString("view.rpa.scenario.operation.result.search.condition.period.all");
	public static final String TODAY = Messages.getString("view.rpa.scenario.operation.result.search.condition.period.today");
	public static final String YESTERDAY = Messages.getString("view.rpa.scenario.operation.result.search.condition.period.yesterday");
	public static final String LAST_WEEK = Messages.getString("view.rpa.scenario.operation.result.search.condition.period.lastWeek");
	public static final String LAST_MONTH = Messages.getString("view.rpa.scenario.operation.result.search.condition.period.lastMonth");
	public static final String PAST_7_DAYS = Messages.getString("view.rpa.scenario.operation.result.search.condition.period.past7days");
	public static final String PAST_30_DAYS = Messages.getString("view.rpa.scenario.operation.result.search.condition.period.past30days");
