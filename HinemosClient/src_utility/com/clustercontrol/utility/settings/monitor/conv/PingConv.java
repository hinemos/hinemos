...
public class PingConv {
	 ...
	 */
	private final static String SCHEMA_TYPE = VersionUtil.getSchemaProperty("MONITOR.PING.SCHEMATYPE");
	private final static String SCHEMA_VERSION = VersionUtil.getSchemaProperty("MONITOR.PING.SCHEMAVERSION");
	private final static String SCHEMA_REVISION =VersionUtil.getSchemaProperty("MONITOR.PING.SCHEMAREVISION");
