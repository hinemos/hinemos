...
@RestBeanConvertAssertion(to = NodeFilesystemInfo.class)
@RestBeanConvertIdClassSet(infoClass = NodeDeviceInfo.class, idName = "id")
public class AgtNodeFilesystemInfoRequest extends AgentRequestDto {
	...
	public AgtNodeFilesystemInfoRequest() {
	}
