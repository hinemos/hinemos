...
#define MIB_DISK_PERCENT		24
#define MIB_DISK_PATH   		25

#define MIB_DISK_IO_OID_LENGTH  13
#define MIB_DISK_PERCENT_OID_LENGTH  11
#define MIB_DISK_PATH_OID_LENGTH  11
...
/**** disk path ****/
UINT MIB_diskPath[26][11]    = {{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 1 },
	  							{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 2 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 3 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 4 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 5 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 6 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 7 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 8 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 9 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 10 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 11 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 12 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 13 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 14 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 16 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 17 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 18 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 19 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 20 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 21 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 22 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 23 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 24 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 25 },
								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 2, 26 }};

/**** disk percent ****/
UINT MIB_diskPercent[26][11]     = {{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 1 },
	  								{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 2 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 3 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 4 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 5 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 6 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 7 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 8 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 9 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 10 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 11 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 12 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 13 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 14 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 16 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 17 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 18 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 19 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 20 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 21 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 22 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 23 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 24 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 25 },
									{ 1, 3, 6, 1, 4, 1, 2021, 9, 1, 9, 26 }};
...
UINT *MIB_diskParcentPtr = &MIB_diskPercent[0][0];
UINT *MIB_diskPathPtr = &MIB_diskPath[0][0];
...
/* 8TBファイルシステム使用率監視 */
map<string, AsnInteger> MIB_dat_diskPercent;
map<string, string> MIB_dat_diskPath;
