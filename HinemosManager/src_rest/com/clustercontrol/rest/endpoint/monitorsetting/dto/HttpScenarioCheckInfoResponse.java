...
public class HttpScenarioCheckInfoResponse {
	...
	public HttpScenarioCheckInfoResponse() {
	}
	...
	public String toString() {
		return "HttpScenarioCheckInfoResponse [authType=" + authType + ", authUser=" + authUser + ", authPassword="
