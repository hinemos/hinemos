...
public class GetInstanceWithStorageResponse {
	...
	// InstanceBackup.convertWebEntity(entity.getBackup())から個別に変換すること。
	private InstanceBackupResponse backup;

	public GetInstanceWithStorageResponse() {
	}
	...
	public InstanceBackupResponse getBackup() {
		return backup;
	}

	public void setBackup(InstanceBackupResponse backup) {
		this.backup = backup;
	}
