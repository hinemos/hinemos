...
public class CustomCheckInfoResponse {
	...
	public CustomCheckInfoResponse() {
	}
	...
	public void setCommandExecTypeCode(CommandExecTypeEnum commandExecTypeCode) {
	...
	public String toString() {
		return "CustomCheckInfoResponse [command=" + command + ", specifyUser=" + specifyUser + ", effectiveUser="
