...
public class UtilityRestFilterRegistration implements DynamicFeature {

	private static final Log log = LogFactory.getLog(UtilityRestFilterRegistration.class);

	@Override
	public void configure(ResourceInfo resourceInfo, FeatureContext context) {
		if (log.isDebugEnabled()) {
			log.debug("UtilityRestFilterRegistration : resourceMethod=" + resourceInfo.getResourceClass().getName() + "#"
					+ resourceInfo.getResourceMethod().getName());
		}
		if (UtilityRestEndpoints.class.isAssignableFrom(resourceInfo.getResourceClass())) {
			// Bearer認証を設定
