...
public class InfraJdbcExecutorSupport {
	...
	public static String execSelectFileContent(String fileId) throws HinemosUnknown {
		Connection conn = null;
		...
		try {
			...
			Path tempFile = null;
			tempFile = RestTempFileUtil.createTempFile(RestTempFileType.INFRA_FILE);
