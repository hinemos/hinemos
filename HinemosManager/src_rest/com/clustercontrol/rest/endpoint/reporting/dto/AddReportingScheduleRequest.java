...
public class AddReportingScheduleRequest implements RequestDto {
	
	public AddReportingScheduleRequest (){}
	...
	public String toString() {
		return "AddReportingRequest [reportScheduleId=" + reportScheduleId + ", description=" + description
				+ ", ownerRoleId=" + ownerRoleId + ", facilityId=" + facilityId
				...
				+ ", validFlg=" + validFlg + ", schedule=" + schedule + ", notifyId=" + notifyRelationList + "]";
	}
