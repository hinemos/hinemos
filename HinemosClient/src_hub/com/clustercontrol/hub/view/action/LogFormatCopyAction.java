...
/**
 * ログ[フォーマット]の作成・変更ダイアログによる、ログフォーマットコピーを行うクライアント側アクションクラス<BR>
 *
 */
public class LogFormatCopyAction extends AbstractHandler implements IElementUpdater{
	/** ログ */
	private static Log m_log = LogFactory.getLog(LogFormatCopyAction.class);
	public static final String ID = LogFormatCopyAction.class.getName();
	...
	public Object execute(final ExecutionEvent event) throws ExecutionException {
		...
		if (id != null) {
			// ダイアログを生成
			LogFormatDialog dialog = new LogFormatDialog(this.viewPart.getSite().getShell(), 
