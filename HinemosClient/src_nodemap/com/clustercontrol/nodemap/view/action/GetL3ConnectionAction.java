 ...
 * @since 1.0.0
 */
public class GetL3ConnectionAction extends AbstractHandler implements IElementUpdater {
	// ログ
	private static Log m_log = LogFactory.getLog( GetL3ConnectionAction.class );
	
	/** アクションID */
	public static final String ID = OpenNodeMapAction.ActionIDBase + GetL3ConnectionAction.class.getSimpleName();
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			...
			m_log.warn("run() getL3Connection, " + e.getMessage(), e);
