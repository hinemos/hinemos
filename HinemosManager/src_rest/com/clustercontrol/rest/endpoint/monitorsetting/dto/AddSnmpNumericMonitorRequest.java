...
public class AddSnmpNumericMonitorRequest extends AbstractAddNumericMonitorRequest {

	public AddSnmpNumericMonitorRequest() {
	...
	public String toString() {
		return "AddSnmpNumericMonitorRequest [snmpCheckInfo=" + snmpCheckInfo + ", collectorFlg=" + collectorFlg
