...
/**
 * 承認[フィルタ処理]のダイアログクラスです。
 *
 * @version 6.0.0
 * @since 6.0.0
 */
public class ApprovalFilterDialog extends CommonDialog {
	/** プロパティシート */
	 ...
	 * @param parent 親シェル
	 */
	public ApprovalFilterDialog(Shell parent) {
		super(parent);
	}
	...
	protected void customizeDialog(Composite parent) {
		...
		shell.setText(Messages.getString("dialog.approval.filter.list"));
