...
/**
 * バイナリフィルタ一覧テーブル定義情報を取得するクライアント側アクションクラス<BR>
 * 
 * @version 6.1.0
 * @since 6.1.0
 */
public class GetBinaryFilterTableDefine {
	...
	public static ArrayList<TableColumnInfo> get() {
		...
		tableDefine.add(PATTERN_STRING,
				new TableColumnInfo(Messages.getString("binary.search.text", locale), TableColumnInfo.NONE, 140, SWT.LEFT));
