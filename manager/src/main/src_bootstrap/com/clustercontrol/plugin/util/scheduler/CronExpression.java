...
public final class CronExpression implements Serializable, Cloneable {
	...
	public static final int MAX_YEAR = HinemosTime.getCalendarInstance().get(Calendar.YEAR) + 100;
	...
	public boolean isSatisfiedBy(Date date) {
		Calendar testDateCal = HinemosTime.getCalendarInstance(getTimeZone());
	...
	public Date getNextInvalidTimeAfter(Date date) {
		...
		Calendar adjustCal = HinemosTime.getCalendarInstance(getTimeZone());
					...
					if (dayOfMSpec && !dayOfWSpec) { // get day by day of month rule
						...
						if (lastdayOfMonth) {
							if(!nearestWeekday) {
								...
								java.util.Calendar tcal = HinemosTime.getCalendarInstance(getTimeZone());
