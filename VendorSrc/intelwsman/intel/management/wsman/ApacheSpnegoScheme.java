 ...
 * @since 4.0
 */
public class ApacheSpnegoScheme implements AuthScheme {

    private static final Logger LOG = LoggerFactory.getLogger(ApacheSpnegoScheme.class);
    ...
    public ApacheSpnegoScheme(final NTLMEngine engine) {
        super();
    ...
    public boolean isResponseReady(
        ...
        final AuthScope authScope = new AuthScope(host, null, StandardAuthScheme.NTLM);
    ...
    public String generateAuthResponse(
        ...
        return StandardAuthScheme.SPNEGO + " " + response;
    }
