...
public class JobWaitRuleInfoRequest implements RequestDto {
	...
	/** ジョブ判定対象情報 */
	private ArrayList<JobObjectGroupInfoRequest> objectGroup = new ArrayList<>();
	...
	public ArrayList<JobObjectGroupInfoRequest> getObjectGroup() {
		return objectGroup;
	}


	public void setObjectGroup(ArrayList<JobObjectGroupInfoRequest> objectGroup) {
	...
	public List<JobNextJobOrderInfoRequest> getExclusiveBranchNextJobOrderList() {
		return exclusiveBranchNextJobOrderList;
	}


	public void setExclusiveBranchNextJobOrderList(List<JobNextJobOrderInfoRequest> exclusiveBranchNextJobOrderList) {
	...
	public void correlationCheck() throws InvalidSetting {
		if (objectGroup != null) {
			for (JobObjectGroupInfoRequest req : objectGroup) {
				req.correlationCheck();
			}
		}
		if (exclusiveBranchNextJobOrderList != null) {
			for (JobNextJobOrderInfoRequest req : exclusiveBranchNextJobOrderList) {
				req.correlationCheck();
			}
		}
	}
