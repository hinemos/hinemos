 ...
 *
 */
public class RestAccessInfoCopyAction extends AbstractHandler implements IElementUpdater {
	/** ログ */
	private static Log m_log = LogFactory.getLog(RestAccessInfoCopyAction.class);
	
	/** アクションID */
	public static final String ID = RestAccessInfoCopyAction.class.getName();
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if(RestAccessInfoId != null){
			RestAccessInfoCreateDialog dialog = new RestAccessInfoCreateDialog(view
					...
					RestAccessInfoId, PropertyDefineConstant.MODE_ADD);
