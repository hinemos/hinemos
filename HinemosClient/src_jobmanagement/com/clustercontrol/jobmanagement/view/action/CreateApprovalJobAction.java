 ...
 * @since 5.1.0
 */
public class CreateApprovalJobAction extends AbstractHandler implements IElementUpdater {
	/** ログ */
	private static Log m_log = LogFactory.getLog(CreateApprovalJobAction.class);
	/** アクションID */
	public static final String ID = CreateApprovalJobAction.class.getName();
	...
	/**
	 * ジョブ[一覧]ビューの「承認ジョブの作成」が押された場合に、承認ジョブを作成します。
	 * <p>
	 * <ol>
	 * <li>ジョブ[一覧]ビューから親となるジョブツリーアイテムを取得します。</li>
	 * <li>承認ジョブ用のジョブ情報を作成し、親のジョブツリーアイテムの子として追加します。</li>
	 * <li>ジョブ[承認ジョブの作成・変更]ダイアログを表示します。</li>
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (parent != null) {
			JobInfoWrapper jobInfo = JobTreeItemUtil.getNewJobInfo(parent.getData().getJobunitId(),
					JobInfoWrapper.TypeEnum.APPROVALJOB);
