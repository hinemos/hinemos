...
@RestBeanConvertAssertion(from = MonitorStringValueInfo.class)
@RestBeanConvertIdClassSet(infoClass = MonitorStringValueInfo.class, idName = "id")
public class AgtMonitorStringValueInfoResponse {

	// ---- MonitorStringValueInfo
	...
	public AgtMonitorStringValueInfoResponse() {
	}
