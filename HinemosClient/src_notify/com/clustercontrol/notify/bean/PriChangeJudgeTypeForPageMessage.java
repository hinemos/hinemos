...
public class PriChangeJudgeTypeForPageMessage {
	/** 重要度変化しない。 */ 
	public static final String STRING_NOT_PRIORITY_CHANGE = Messages.getString("notify.priority.change.none");

	/** ページをまたいて重要度変化する。 */
	public static final String STRING_ACROSS_MONITOR_DETAIL_ID = Messages.getString("notify.priority.change.occur.page");
