...
/**
 * SDML制御設定を変更するビューアクション
 *
 */
public class SdmlControlSettingModifyAction extends AbstractHandler implements IElementUpdater {
	private static Log logger = LogFactory.getLog(SdmlControlSettingModifyAction.class);

	/** アクションID */
	public static final String ID = SdmlControlSettingModifyAction.class.getName();
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (applicationId != null) {
			...
			SdmlControlSettingCreateDialog dialog = new SdmlControlSettingCreateDialog(
					this.viewPart.getSite().getShell(), managerName, applicationId, PropertyDefineConstant.MODE_MODIFY);
