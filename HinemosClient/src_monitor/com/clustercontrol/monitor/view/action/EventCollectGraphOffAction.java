 ...
 * @since 1.0.0
 */
public class EventCollectGraphOffAction extends AbstractHandler implements IElementUpdater {

	// ログ
	private static Log m_log = LogFactory.getLog( EventCollectGraphOffAction.class );

	/** アクションID */
	public static final String ID = EventCollectGraphOffAction.class.getName();
