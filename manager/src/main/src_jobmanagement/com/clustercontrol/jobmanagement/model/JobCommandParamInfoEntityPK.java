...
/**
 * The primary key class for the cc_job_command_param_info database table.
 * 
 */
@Embeddable
public class JobCommandParamInfoEntityPK implements Serializable {
	...
	public JobCommandParamInfoEntityPK() {
	}

	public JobCommandParamInfoEntityPK(String sessionId, String jobunitId, String jobId, String paramId) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof JobCommandParamInfoEntityPK)) {
			return false;
		}
		JobCommandParamInfoEntityPK castOther = (JobCommandParamInfoEntityPK)other;
		return
