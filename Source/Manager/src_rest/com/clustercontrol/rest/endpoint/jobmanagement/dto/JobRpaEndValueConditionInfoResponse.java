...
public class JobRpaEndValueConditionInfoResponse {
	...
	public JobRpaEndValueConditionInfoResponse() {
	}
	...
	/**
	 * @param caseSensitivityFlg the caseSensitivityFlg to set
	 */
	...
	/**
	 * @param returnCodeCondition the returnCodeCondition to set
	 */
	...
	/**
	 * @param useCommandReturnCodeFlg the useCommandReturnCodeFlg to set
	 */
