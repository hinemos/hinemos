 ...
 * @version 4.0.1
 */
public class CollectorPollingMstData
...
implements java.io.Serializable
{
	...
	public CollectorPollingMstData( java.lang.String collectMethod,java.lang.String platformId,java.lang.String subPlatformId,java.lang.String itemCode,java.lang.String variableId,java.lang.String entryKey,java.lang.String valueType,java.lang.String pollingTarget,java.lang.String failureValue )
	{
	...
	public com.clustercontrol.performance.monitor.entity.CollectorPollingMstPK getPrimaryKey() {
		com.clustercontrol.performance.monitor.entity.CollectorPollingMstPK pk = new com.clustercontrol.performance.monitor.entity.CollectorPollingMstPK(this.getCollectMethod(),this.getPlatformId(),this.getSubPlatformId(),this.getItemCode(),this.getVariableId());
		return pk;
	}
	...
	public String toString()
	{
		...
		str.append("collectMethod=" + getCollectMethod() + " " + "platformId=" + getPlatformId() + " " + "subPlatformId=" + getSubPlatformId() + " " + "itemCode=" + getItemCode() + " " + "variableId=" + getVariableId() + " " + "entryKey=" + getEntryKey() + " " + "valueType=" + getValueType() + " " + "pollingTarget=" + getPollingTarget() + " " + "failureValue=" + getFailureValue());
		str.append('}');
