...
package com.clustercontrol.jobmap.messages;
...
public class Messages {
	private static final String RESOURCE_BUNDLE = "com.clustercontrol.jobmap.messages.messages";
	...
	public static String getString(String key, Object[] args, Locale locale) {
		return MessageFormat.format(getString(key, locale), args);
	}
