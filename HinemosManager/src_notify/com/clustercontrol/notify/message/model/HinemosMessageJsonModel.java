...
package com.clustercontrol.notify.message.model;

/**
 * メッセージ通知用のHinemosメッセージモデルクラス
 */
public class HinemosMessageJsonModel {

	private String format;
	private String sourceId;
	private String destinationId;
	private String sentTime;
	private MessageJsonModel[] messages;

	public HinemosMessageJsonModel() {
	}
	...
	public MessageJsonModel[] getMessages() {
		return messages;
	}

	public void setMessages(MessageJsonModel[] messages) {
