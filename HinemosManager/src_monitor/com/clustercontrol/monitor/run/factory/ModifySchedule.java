...
public class ModifySchedule {
	...
	protected void updateSchedule(String monitorId) throws HinemosUnknown {
		...
		try (JpaTransactionManager jtm = new JpaTransactionManager()) {
			...
			try {
				...
				String msg = "updateSchedule() scheduleJob : monitorId = " + monitorId + e.getClass().getSimpleName()
						+ ", " + e.getMessage();
				m_log.warn(msg, e);
	 ...
	 * @since 6.2.2
	 */
	public void updateSchedule(MonitorInfo entity, JpaTransactionManager jtm) throws HinemosUnknown {
		m_log.debug("updateSchedule() : monitorId=" + entity.getMonitorId());
	...
	private void updateSchedule(
		...
		try {
			...
			m_log.info("updateSchedule() Invalid TRIGGER_TYPE. monitorTypeId = " + monitorTypeId + ", + monitorId = "
					+ monitorId);
			return;
		}
	 ...
	 * @see com.clustercontrol.quartzmanager.ejb.session.QuartzManager#deleteSchedule(java.lang.String,
	 *      java.lang.String)
	 */
	...
	// }
	//
	// m_log.debug("getCronString() interval = " + interval + ", delayTime = " +
	// delayTime + ", cronString = " + cronString);
	// return cronString;
	// }
