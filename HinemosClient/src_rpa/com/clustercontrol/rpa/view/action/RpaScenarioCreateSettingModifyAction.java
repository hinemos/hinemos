...
/**
 * RPA設定[シナリオ実績作成設定]ビューの編集アクションクラス<BR>
 */
public class RpaScenarioCreateSettingModifyAction extends AbstractHandler implements IElementUpdater {

	// ログ
	private static Log log = LogFactory.getLog(RpaScenarioCreateSettingModifyAction.class);

	/** アクションID */
	public static final String ID = RpaScenarioCreateSettingModifyAction.class.getName();
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		RpaScenarioOperationResultCreateSettingListComposite composite = (RpaScenarioOperationResultCreateSettingListComposite) view
				.getListComposite();
