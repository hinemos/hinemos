...
public class PortConv {
	 ...
	 */
	private final static String SCHEMA_TYPE = VersionUtil.getSchemaProperty("MONITOR.PORT.SCHEMATYPE");
	private final static String SCHEMA_VERSION = VersionUtil.getSchemaProperty("MONITOR.PORT.SCHEMAVERSION");
	private final static String SCHEMA_REVISION =VersionUtil.getSchemaProperty("MONITOR.PORT.SCHEMAREVISION");
