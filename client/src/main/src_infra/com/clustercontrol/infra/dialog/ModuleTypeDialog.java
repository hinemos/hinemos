...
public class ModuleTypeDialog extends CommonDialog {
	...
	protected void okPressed() {
		...
		} else if (getSelectItem().equals(ModuleTypeMessage.STRING_REFERMANAGEMENT)){
			dialog = new ReferManagementModuleDialog(getShell(), this.managerName, this.managementId);
		} else {
