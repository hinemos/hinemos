...
public class PortCheckInfoRequest implements RequestDto {
	...
	public String toString() {
		return "PortCheckInfoRequest [portNo=" + portNo + ", runCount=" + runCount + ", runInterval=" + runInterval
