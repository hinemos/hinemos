 ...
 * @version 4.0.1
 */
public class SnmpTrapMibMasterData
...
implements java.io.Serializable
{
	...
	public SnmpTrapMibMasterData( java.lang.String mib,java.lang.Integer orderNo,java.lang.String description,long regDate,long updateDate,java.lang.String regUser,java.lang.String updateUser )
	{
		setMib(mib);
		setOrderNo(orderNo);
	...
	public com.clustercontrol.snmptrap.entity.SnmpTrapMibMasterPK getPrimaryKey() {
		com.clustercontrol.snmptrap.entity.SnmpTrapMibMasterPK pk = new com.clustercontrol.snmptrap.entity.SnmpTrapMibMasterPK(this.getMib());
		return pk;
	}
	...
	public String toString()
	{
		...
		str.append("mib=" + getMib() + " " + "orderNo=" + getOrderNo() + " " + "description=" + getDescription() + " " + "regDate=" + getRegDate() + " " + "updateDate=" + getUpdateDate() + " " + "regUser=" + getRegUser() + " " + "updateUser=" + getUpdateUser());
		str.append('}');
