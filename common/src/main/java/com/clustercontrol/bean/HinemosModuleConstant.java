...
public class HinemosModuleConstant {
	...
	static {
		CODEMAP.put(PLATFORM_ACCESS, "ACCESSCONTROL");
		CODEMAP.put(PLATFORM_PRIORITY_JUDGMENT, "PRIORITY_JUDGMENT");
		CODEMAP.put(PLATFORM_CALENDAR, "CALENDAR");
		CODEMAP.put(PLATFORM_CALENDAR_PATTERN, "CALENDAR_PATTERN");
		CODEMAP.put(PLATFORM_REPOSITORY, "REPOSITORY");
		CODEMAP.put(PLATFORM_NOTIFY, "NOTIFY");
		CODEMAP.put(PLATFORM_MAIL_TEMPLATE, "MAIL_TEMPLATE");
		CODEMAP.put(MONITOR, "MONITOR_SETTING");
		CODEMAP.put(MONITOR_AGENT, "AGENT_MONITOR");
		CODEMAP.put(MONITOR_CUSTOM_N, "CUSTOM_MONITOR_N");
		CODEMAP.put(MONITOR_CUSTOM_S, "CUSTOM_MONITOR_S");
		CODEMAP.put(MONITOR_HTTP_N, "HTTP_MONITOR_N");
		CODEMAP.put(MONITOR_HTTP_S, "HTTP_MONITOR_S");
		CODEMAP.put(MONITOR_HTTP_SCENARIO, "HTTP_MONITOR_SCENARIO");
		CODEMAP.put(MONITOR_PING, "PING_MONITOR");
		CODEMAP.put(MONITOR_PROCESS, "PROCESS_MONITOR");
		CODEMAP.put(MONITOR_SNMP_N, "SNMP_MONITOR_N");
		CODEMAP.put(MONITOR_SNMP_S, "SNMP_MONITOR_S");
		CODEMAP.put(MONITOR_SNMPTRAP, "SNMPTRAP_MONITOR");
		CODEMAP.put(MONITOR_SQL_N, "SQL_MONITOR_N");
		CODEMAP.put(MONITOR_SQL_S, "SQL_MONITOR_S");
		CODEMAP.put(MONITOR_PERFORMANCE, "PERFORMANCE_MONITOR");
		CODEMAP.put(MONITOR_PORT, "PORT_MONITOR");
		CODEMAP.put(MONITOR_WINSERVICE, "WINSERVICE_MONITOR");
		CODEMAP.put(MONITOR_WINEVENT, "WINEVENT_MONITOR");
		CODEMAP.put(MONITOR_JMX, "JMX_MONITOR");
		CODEMAP.put(HUB_LOGFORMAT, "LOG_FORMAT");
		CODEMAP.put(HUB_TRANSFER, "LOG_TRANSFER");
		CODEMAP.put(MONITOR_SYSTEMLOG, "SYSTEMLOG_MONITOR");
		CODEMAP.put(MONITOR_LOGFILE, "LOGFILE_MONITOR");
		CODEMAP.put(MONITOR_LOGCOUNT, "LOGCOUNT_MONITOR");
		CODEMAP.put(MONITOR_CORRELATION, "COLLECT_MONITOR");
		CODEMAP.put(MONITOR_INTEGRATION, "INTEGRATION_MONITOR");
		CODEMAP.put(PERFORMANCE, "PERFORMANCE");
		CODEMAP.put(JOB, "JOB_MANAGEMENT");
		CODEMAP.put(JOB_MST, "JOB_MANAGEMENT");
		CODEMAP.put(JOB_KICK, "JOB_KICK");
		CODEMAP.put(SYSYTEM_MAINTENANCE, "MAINTENANCE_NAME");
		CODEMAP.put(SYSYTEM_SELFCHECK, "SELFCHECK_NAME");
		CODEMAP.put(INFRA, "INFRA_MANAGEMENT");
		CODEMAP.put(INFRA_FILE, "INFRA_FILE_MANAGER");
		CODEMAP.put(REPORTING, "REPORTING");
		CODEMAP.put(HINEMOS_MANAGER_MONITOR, "MNG");
		CODEMAP.put(MONITOR_CUSTOMTRAP_N, "CUSTOMTRAP_MONITOR_N");
		CODEMAP.put(MONITOR_CUSTOMTRAP_S, "CUSTOMTRAP_MONITOR_S");
		CODEMAP.put(MONITOR_BINARYFILE_BIN, "BINARYFILE_MONITOR_BIN");
		CODEMAP.put(MONITOR_PCAP_BIN, "PCAP_MONITOR_BIN");
	}
