...
@Provider
public class FilterSettingRestFilterRegistration implements DynamicFeature {
	private static final Log log = LogFactory.getLog(FilterSettingRestFilterRegistration.class);

	@Override
	public void configure(ResourceInfo resourceInfo, FeatureContext context) {
		if (log.isDebugEnabled()) {
			log.debug("FilterSettingRestFilterRegistration : resourceMethod=" + resourceInfo.getResourceClass().getName()
					+ "#" + resourceInfo.getResourceMethod().getName());
		}
		if (FilterSettingRestEndpoints.class.isAssignableFrom(resourceInfo.getResourceClass())) {
