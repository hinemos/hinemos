 ...
 * @since 1.0.0
 */
public class ReportingAddAction extends AbstractHandler{
	/** ログ */
	private static Log m_log = LogFactory.getLog(ReportingAddAction.class);

	/** アクションID */
	public static final String ID = ReportingAddAction.class.getName();
