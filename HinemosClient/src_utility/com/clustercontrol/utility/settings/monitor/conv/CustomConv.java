...
public class CustomConv {
	 ...
	 */
	static private String SCHEMA_TYPE = VersionUtil.getSchemaProperty("MONITOR.CUSTOM.SCHEMATYPE");
	static private String SCHEMA_VERSION = VersionUtil.getSchemaProperty("MONITOR.CUSTOM.SCHEMAVERSION");
	static private String SCHEMA_REVISION =VersionUtil.getSchemaProperty("MONITOR.CUSTOM.SCHEMAREVISION");
